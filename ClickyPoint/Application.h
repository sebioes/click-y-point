...
private:
  enum class AppState { Default, Menu, SensitivityAdjustment, IMUDisplay };
  ...
  static constexpr uint16_t leftClickDebounceDelay =
      100; // Left click debounce millis
  static constexpr uint16_t arrowCooldownDuration =
      500; // Arrow press cooldown millis
  static constexpr uint16_t arrowDetectionMaxIterations =
      80; // Arrow threshold detection length
